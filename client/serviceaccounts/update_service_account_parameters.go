...
func NewUpdateServiceAccountParams() *UpdateServiceAccountParams {
	return NewUpdateServiceAccountParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpdateServiceAccountParams].

...
func NewListOpenstackTenantsNoCredentialsV2Params() *ListOpenstackTenantsNoCredentialsV2Params {
	return NewListOpenstackTenantsNoCredentialsV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListOpenstackTenantsNoCredentialsV2Params].

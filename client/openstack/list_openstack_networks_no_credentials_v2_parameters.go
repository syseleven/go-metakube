...
func NewListOpenstackNetworksNoCredentialsV2Params() *ListOpenstackNetworksNoCredentialsV2Params {
	return NewListOpenstackNetworksNoCredentialsV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListOpenstackNetworksNoCredentialsV2Params].

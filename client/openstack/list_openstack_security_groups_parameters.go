...
func NewListOpenstackSecurityGroupsParams() *ListOpenstackSecurityGroupsParams {
	return NewListOpenstackSecurityGroupsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListOpenstackSecurityGroupsParams].

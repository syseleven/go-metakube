...
func NewListOpenstackSizesNoCredentialsV2Params() *ListOpenstackSizesNoCredentialsV2Params {
	return NewListOpenstackSizesNoCredentialsV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListOpenstackSizesNoCredentialsV2Params].

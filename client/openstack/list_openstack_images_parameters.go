...
func NewListOpenstackImagesParams() *ListOpenstackImagesParams {
	return NewListOpenstackImagesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListOpenstackImagesParams].

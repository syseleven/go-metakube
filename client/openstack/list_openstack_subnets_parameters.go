...
func NewListOpenstackSubnetsParams() *ListOpenstackSubnetsParams {
	return NewListOpenstackSubnetsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListOpenstackSubnetsParams].

...
func NewListOpenstackSizesParams() *ListOpenstackSizesParams {
	return NewListOpenstackSizesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListOpenstackSizesParams].

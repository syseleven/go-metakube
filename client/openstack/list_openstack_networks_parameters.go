...
func NewListOpenstackNetworksParams() *ListOpenstackNetworksParams {
	return NewListOpenstackNetworksParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListOpenstackNetworksParams].

...
func NewListOpenstackAvailabilityZonesParams() *ListOpenstackAvailabilityZonesParams {
	return NewListOpenstackAvailabilityZonesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListOpenstackAvailabilityZonesParams].
...
func (o *ListOpenstackAvailabilityZonesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.OIDCAuthentication != nil {
		...
		if err := r.SetHeaderParam("OIDCAuthentication", conv.FormatBool(*o.OIDCAuthentication)); err != nil {
			return err
		}
	}

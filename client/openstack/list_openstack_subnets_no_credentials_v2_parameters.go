...
func NewListOpenstackSubnetsNoCredentialsV2Params() *ListOpenstackSubnetsNoCredentialsV2Params {
	return NewListOpenstackSubnetsNoCredentialsV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListOpenstackSubnetsNoCredentialsV2Params].

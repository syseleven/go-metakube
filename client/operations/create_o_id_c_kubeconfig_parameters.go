...
func NewCreateOIDCKubeconfigParams() *CreateOIDCKubeconfigParams {
	return NewCreateOIDCKubeconfigParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateOIDCKubeconfigParams].

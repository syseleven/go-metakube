...
func NewListAWSSizesNoCredentialsV2Params() *ListAWSSizesNoCredentialsV2Params {
	return NewListAWSSizesNoCredentialsV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListAWSSizesNoCredentialsV2Params].

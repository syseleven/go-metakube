...
func NewListAWSSubnetsParams() *ListAWSSubnetsParams {
	return NewListAWSSubnetsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListAWSSubnetsParams].

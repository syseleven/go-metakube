...
func NewListAWSVPCSParams() *ListAWSVPCSParams {
	return NewListAWSVPCSParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListAWSVPCSParams].

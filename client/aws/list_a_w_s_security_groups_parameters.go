...
func NewListAWSSecurityGroupsParams() *ListAWSSecurityGroupsParams {
	return NewListAWSSecurityGroupsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListAWSSecurityGroupsParams].

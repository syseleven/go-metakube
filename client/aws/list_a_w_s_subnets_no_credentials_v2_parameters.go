...
func NewListAWSSubnetsNoCredentialsV2Params() *ListAWSSubnetsNoCredentialsV2Params {
	return NewListAWSSubnetsNoCredentialsV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListAWSSubnetsNoCredentialsV2Params].

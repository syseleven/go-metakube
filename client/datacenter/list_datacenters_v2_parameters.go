...
func NewListDatacentersV2Params() *ListDatacentersV2Params {
	return NewListDatacentersV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListDatacentersV2Params].

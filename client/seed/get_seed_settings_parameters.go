...
func NewGetSeedSettingsParams() *GetSeedSettingsParams {
	return NewGetSeedSettingsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetSeedSettingsParams].

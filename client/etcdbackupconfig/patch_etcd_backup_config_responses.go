...
func (o *PatchEtcdBackupConfigForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /api/v2/projects/{project_id}/clusters/{cluster_id}/etcdbackupconfigs/{ebc_id}][%d] patchEtcdBackupConfigForbidden %s", 403, payload)
}
...
func (o *PatchEtcdBackupConfigForbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

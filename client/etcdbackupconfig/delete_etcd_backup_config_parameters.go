...
func NewDeleteEtcdBackupConfigParams() *DeleteEtcdBackupConfigParams {
	return NewDeleteEtcdBackupConfigParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteEtcdBackupConfigParams].

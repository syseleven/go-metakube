...
func NewListProjectEtcdBackupConfigParams() *ListProjectEtcdBackupConfigParams {
	return NewListProjectEtcdBackupConfigParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListProjectEtcdBackupConfigParams].

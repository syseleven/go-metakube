...
func NewCreateEtcdBackupConfigParams() *CreateEtcdBackupConfigParams {
	return NewCreateEtcdBackupConfigParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateEtcdBackupConfigParams].

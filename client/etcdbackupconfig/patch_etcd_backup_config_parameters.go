...
func NewPatchEtcdBackupConfigParams() *PatchEtcdBackupConfigParams {
	return NewPatchEtcdBackupConfigParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PatchEtcdBackupConfigParams].

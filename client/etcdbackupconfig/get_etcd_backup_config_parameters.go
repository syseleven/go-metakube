...
func NewGetEtcdBackupConfigParams() *GetEtcdBackupConfigParams {
	return NewGetEtcdBackupConfigParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetEtcdBackupConfigParams].

...
func NewListEtcdBackupConfigParams() *ListEtcdBackupConfigParams {
	return NewListEtcdBackupConfigParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListEtcdBackupConfigParams].

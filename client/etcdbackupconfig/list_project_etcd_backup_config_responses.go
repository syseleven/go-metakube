...
func (o *ListProjectEtcdBackupConfigForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/etcdbackupconfigs][%d] listProjectEtcdBackupConfigForbidden %s", 403, payload)
}
...
func (o *ListProjectEtcdBackupConfigForbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

...
func NewGetMasterVersionsParams() *GetMasterVersionsParams {
	return NewGetMasterVersionsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetMasterVersionsParams].

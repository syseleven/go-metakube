...
func NewUpdateServiceAccountTokenParams() *UpdateServiceAccountTokenParams {
	return NewUpdateServiceAccountTokenParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpdateServiceAccountTokenParams].

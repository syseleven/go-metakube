...
func (o *DeleteServiceAccountTokenForbidden) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/projects/{project_id}/serviceaccounts/{serviceaccount_id}/tokens/{token_id}][%d] deleteServiceAccountTokenForbidden %s", 403, payload)
}
...
func (o *DeleteServiceAccountTokenForbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

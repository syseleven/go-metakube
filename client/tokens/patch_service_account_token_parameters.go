...
func NewPatchServiceAccountTokenParams() *PatchServiceAccountTokenParams {
	return NewPatchServiceAccountTokenParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PatchServiceAccountTokenParams].

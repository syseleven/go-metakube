...
func NewDeleteServiceAccountTokenParams() *DeleteServiceAccountTokenParams {
	return NewDeleteServiceAccountTokenParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteServiceAccountTokenParams].

...
func NewListServiceAccountTokensParams() *ListServiceAccountTokensParams {
	return NewListServiceAccountTokensParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListServiceAccountTokensParams].

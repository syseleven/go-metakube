...
func (o *ListMachineDeploymentMetricsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/machinedeployments/{machinedeployment_id}/nodes/metrics][%d] listMachineDeploymentMetricsForbidden %s", 403, payload)
}
...
func (o *ListMachineDeploymentMetricsForbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

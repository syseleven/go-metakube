...
func NewListMachineDeploymentMetricsParams() *ListMachineDeploymentMetricsParams {
	return NewListMachineDeploymentMetricsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListMachineDeploymentMetricsParams].

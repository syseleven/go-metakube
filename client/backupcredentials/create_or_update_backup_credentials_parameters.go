...
func NewCreateOrUpdateBackupCredentialsParams() *CreateOrUpdateBackupCredentialsParams {
	return NewCreateOrUpdateBackupCredentialsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateOrUpdateBackupCredentialsParams].

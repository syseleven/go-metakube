...
func NewPatchMachineDeploymentParams() *PatchMachineDeploymentParams {
	return NewPatchMachineDeploymentParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PatchMachineDeploymentParams].

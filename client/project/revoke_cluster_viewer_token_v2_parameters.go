...
func NewRevokeClusterViewerTokenV2Params() *RevokeClusterViewerTokenV2Params {
	return NewRevokeClusterViewerTokenV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [RevokeClusterViewerTokenV2Params].

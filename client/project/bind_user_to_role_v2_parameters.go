...
func NewBindUserToRoleV2Params() *BindUserToRoleV2Params {
	return NewBindUserToRoleV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [BindUserToRoleV2Params].

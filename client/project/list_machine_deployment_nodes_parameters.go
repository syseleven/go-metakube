...
func NewListMachineDeploymentNodesParams() *ListMachineDeploymentNodesParams {
	return NewListMachineDeploymentNodesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListMachineDeploymentNodesParams].

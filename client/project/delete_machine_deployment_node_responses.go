...
func (o *DeleteMachineDeploymentNodeForbidden) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v2/projects/{project_id}/clusters/{cluster_id}/machinedeployments/nodes/{node_id}][%d] deleteMachineDeploymentNodeForbidden %s", 403, payload)
}
...
func (o *DeleteMachineDeploymentNodeForbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

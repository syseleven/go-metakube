...
func (o *BindUserToRoleV2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v2/projects/{project_id}/clusters/{cluster_id}/roles/{namespace}/{role_id}/bindings][%d] bindUserToRoleV2Forbidden %s", 403, payload)
}
...
func (o *BindUserToRoleV2Forbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

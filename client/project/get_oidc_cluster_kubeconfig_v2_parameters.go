...
func NewGetOidcClusterKubeconfigV2Params() *GetOidcClusterKubeconfigV2Params {
	return NewGetOidcClusterKubeconfigV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetOidcClusterKubeconfigV2Params].

...
func NewGetClusterMetricsV2Params() *GetClusterMetricsV2Params {
	return NewGetClusterMetricsV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetClusterMetricsV2Params].

...
func (o *CreateMaintenanceCronJobReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CreateMaintenanceCronJobForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v2/projects/{project_id}/clusters/{cluster_id}/maintenancecronjobs][%d] createMaintenanceCronJobForbidden %s", 403, payload)
}
...
func (o *CreateMaintenanceCronJobForbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

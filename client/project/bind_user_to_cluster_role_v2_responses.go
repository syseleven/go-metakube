...
func (o *BindUserToClusterRoleV2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v2/projects/{project_id}/clusters/{cluster_id}/clusterroles/{role_id}/clusterbindings][%d] bindUserToClusterRoleV2Forbidden %s", 403, payload)
}
...
func (o *BindUserToClusterRoleV2Forbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

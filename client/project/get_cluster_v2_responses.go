...
func (o *GetClusterV2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}][%d] getClusterV2Forbidden %s", 403, payload)
}
...
func (o *GetClusterV2Forbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

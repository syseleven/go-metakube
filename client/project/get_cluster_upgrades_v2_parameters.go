...
func NewGetClusterUpgradesV2Params() *GetClusterUpgradesV2Params {
	return NewGetClusterUpgradesV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetClusterUpgradesV2Params].

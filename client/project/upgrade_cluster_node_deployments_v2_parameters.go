...
func NewUpgradeClusterNodeDeploymentsV2Params() *UpgradeClusterNodeDeploymentsV2Params {
	return NewUpgradeClusterNodeDeploymentsV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpgradeClusterNodeDeploymentsV2Params].

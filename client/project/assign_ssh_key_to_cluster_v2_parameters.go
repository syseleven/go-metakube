...
func NewAssignSSHKeyToClusterV2Params() *AssignSSHKeyToClusterV2Params {
	return NewAssignSSHKeyToClusterV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [AssignSSHKeyToClusterV2Params].

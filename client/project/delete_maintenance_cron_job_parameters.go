...
func NewDeleteMaintenanceCronJobParams() *DeleteMaintenanceCronJobParams {
	return NewDeleteMaintenanceCronJobParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteMaintenanceCronJobParams].

...
func NewCreateSSHKeyParams() *CreateSSHKeyParams {
	return NewCreateSSHKeyParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateSSHKeyParams].

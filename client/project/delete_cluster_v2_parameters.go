...
func NewDeleteClusterV2Params() *DeleteClusterV2Params {
	return NewDeleteClusterV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteClusterV2Params].

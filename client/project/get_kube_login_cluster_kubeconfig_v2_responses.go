...
func (o *GetKubeLoginClusterKubeconfigV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetKubeLoginClusterKubeconfigV2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/kubeloginkubeconfig][%d] getKubeLoginClusterKubeconfigV2Forbidden %s", 403, payload)
}
...
func (o *GetKubeLoginClusterKubeconfigV2Forbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

...
func (o *DeleteClusterV2Forbidden) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v2/projects/{project_id}/clusters/{cluster_id}][%d] deleteClusterV2Forbidden %s", 403, payload)
}
...
func (o *DeleteClusterV2Forbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

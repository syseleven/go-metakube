...
func NewGetClusterV2Params() *GetClusterV2Params {
	return NewGetClusterV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetClusterV2Params].

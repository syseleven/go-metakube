...
func NewListSSHKeysAssignedToClusterV2Params() *ListSSHKeysAssignedToClusterV2Params {
	return NewListSSHKeysAssignedToClusterV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListSSHKeysAssignedToClusterV2Params].

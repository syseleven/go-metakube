...
func NewRestartMachineDeploymentParams() *RestartMachineDeploymentParams {
	return NewRestartMachineDeploymentParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [RestartMachineDeploymentParams].

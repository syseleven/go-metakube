...
func NewListRoleNamesV2Params() *ListRoleNamesV2Params {
	return NewListRoleNamesV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListRoleNamesV2Params].

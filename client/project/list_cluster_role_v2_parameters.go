...
func NewListClusterRoleV2Params() *ListClusterRoleV2Params {
	return NewListClusterRoleV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListClusterRoleV2Params].

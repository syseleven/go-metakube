...
func NewListNamespaceV2Params() *ListNamespaceV2Params {
	return NewListNamespaceV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListNamespaceV2Params].

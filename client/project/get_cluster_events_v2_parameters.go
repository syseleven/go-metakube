...
func NewGetClusterEventsV2Params() *GetClusterEventsV2Params {
	return NewGetClusterEventsV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetClusterEventsV2Params].

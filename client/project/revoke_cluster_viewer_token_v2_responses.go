...
func (o *RevokeClusterViewerTokenV2Forbidden) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v2/projects/{project_id}/clusters/{cluster_id}/viewertoken][%d] revokeClusterViewerTokenV2Forbidden %s", 403, payload)
}
...
func (o *RevokeClusterViewerTokenV2Forbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

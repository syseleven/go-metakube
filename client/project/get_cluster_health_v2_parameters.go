...
func NewGetClusterHealthV2Params() *GetClusterHealthV2Params {
	return NewGetClusterHealthV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetClusterHealthV2Params].

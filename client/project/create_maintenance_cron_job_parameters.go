...
func NewCreateMaintenanceCronJobParams() *CreateMaintenanceCronJobParams {
	return NewCreateMaintenanceCronJobParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateMaintenanceCronJobParams].

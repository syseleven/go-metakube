...
func NewListSSHKeysParams() *ListSSHKeysParams {
	return NewListSSHKeysParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListSSHKeysParams].

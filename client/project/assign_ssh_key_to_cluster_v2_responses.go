...
func (o *AssignSSHKeyToClusterV2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v2/projects/{project_id}/clusters/{cluster_id}/sshkeys/{key_id}][%d] assignSshKeyToClusterV2Forbidden %s", 403, payload)
}
...
func (o *AssignSSHKeyToClusterV2Forbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

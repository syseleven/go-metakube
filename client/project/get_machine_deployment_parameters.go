...
func NewGetMachineDeploymentParams() *GetMachineDeploymentParams {
	return NewGetMachineDeploymentParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetMachineDeploymentParams].

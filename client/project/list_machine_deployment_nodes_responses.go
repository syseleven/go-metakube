...
func (o *ListMachineDeploymentNodesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/machinedeployments/{machinedeployment_id}/nodes][%d] listMachineDeploymentNodesForbidden %s", 403, payload)
}
...
func (o *ListMachineDeploymentNodesForbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

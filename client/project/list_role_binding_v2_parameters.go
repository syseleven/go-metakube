...
func NewListRoleBindingV2Params() *ListRoleBindingV2Params {
	return NewListRoleBindingV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListRoleBindingV2Params].

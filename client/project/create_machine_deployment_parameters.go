...
func NewCreateMachineDeploymentParams() *CreateMachineDeploymentParams {
	return NewCreateMachineDeploymentParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateMachineDeploymentParams].

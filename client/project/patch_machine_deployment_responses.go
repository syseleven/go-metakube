...
func (o *PatchMachineDeploymentForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /api/v2/projects/{project_id}/clusters/{cluster_id}/machinedeployments/{machinedeployment_id}][%d] patchMachineDeploymentForbidden %s", 403, payload)
}
...
func (o *PatchMachineDeploymentForbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

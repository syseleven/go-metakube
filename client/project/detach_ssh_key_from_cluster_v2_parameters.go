...
func NewDetachSSHKeyFromClusterV2Params() *DetachSSHKeyFromClusterV2Params {
	return NewDetachSSHKeyFromClusterV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DetachSSHKeyFromClusterV2Params].

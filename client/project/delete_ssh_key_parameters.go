...
func NewDeleteSSHKeyParams() *DeleteSSHKeyParams {
	return NewDeleteSSHKeyParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteSSHKeyParams].

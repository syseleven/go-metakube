...
func (o *GetClusterEventsV2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/events][%d] getClusterEventsV2Forbidden %s", 403, payload)
}
...
func (o *GetClusterEventsV2Forbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

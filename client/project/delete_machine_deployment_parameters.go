...
func NewDeleteMachineDeploymentParams() *DeleteMachineDeploymentParams {
	return NewDeleteMachineDeploymentParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteMachineDeploymentParams].

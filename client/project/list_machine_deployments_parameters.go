...
func NewListMachineDeploymentsParams() *ListMachineDeploymentsParams {
	return NewListMachineDeploymentsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListMachineDeploymentsParams].

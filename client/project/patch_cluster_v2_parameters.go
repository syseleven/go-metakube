...
func NewPatchClusterV2Params() *PatchClusterV2Params {
	return NewPatchClusterV2ParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PatchClusterV2Params].

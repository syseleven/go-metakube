...
func (o *CreateEtcdRestoreForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v2/projects/{project_id}/clusters/{cluster_id}/etcdrestores][%d] createEtcdRestoreForbidden %s", 403, payload)
}
...
func (o *CreateEtcdRestoreForbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

...
func (o *ListEtcdRestoreForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/etcdrestores][%d] listEtcdRestoreForbidden %s", 403, payload)
}
...
func (o *ListEtcdRestoreForbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}

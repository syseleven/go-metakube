...
func NewListEtcdRestoreParams() *ListEtcdRestoreParams {
	return NewListEtcdRestoreParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListEtcdRestoreParams].

...
func NewGetEtcdRestoreParams() *GetEtcdRestoreParams {
	return NewGetEtcdRestoreParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetEtcdRestoreParams].

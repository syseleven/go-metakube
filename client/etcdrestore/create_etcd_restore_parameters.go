...
func NewCreateEtcdRestoreParams() *CreateEtcdRestoreParams {
	return NewCreateEtcdRestoreParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateEtcdRestoreParams].

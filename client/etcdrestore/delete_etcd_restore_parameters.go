...
func NewDeleteEtcdRestoreParams() *DeleteEtcdRestoreParams {
	return NewDeleteEtcdRestoreParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteEtcdRestoreParams].

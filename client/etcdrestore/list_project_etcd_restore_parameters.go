...
func NewListProjectEtcdRestoreParams() *ListProjectEtcdRestoreParams {
	return NewListProjectEtcdRestoreParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListProjectEtcdRestoreParams].

...
func NewListVersionsByProviderParams() *ListVersionsByProviderParams {
	return NewListVersionsByProviderParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListVersionsByProviderParams].

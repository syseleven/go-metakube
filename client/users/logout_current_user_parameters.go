...
func NewLogoutCurrentUserParams() *LogoutCurrentUserParams {
	return NewLogoutCurrentUserParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [LogoutCurrentUserParams].

...
func NewDeleteUserFromProjectParams() *DeleteUserFromProjectParams {
	return NewDeleteUserFromProjectParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteUserFromProjectParams].

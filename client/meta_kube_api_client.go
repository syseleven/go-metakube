...
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *MetaKubeAPI {
	// ensure nullable parameters have default
	if formats == nil {
...
func (c *MetaKubeAPI) SetTransport(transport runtime.ContextualTransport) {

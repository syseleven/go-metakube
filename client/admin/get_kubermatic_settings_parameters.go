...
func NewGetKubermaticSettingsParams() *GetKubermaticSettingsParams {
	return NewGetKubermaticSettingsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetKubermaticSettingsParams].
